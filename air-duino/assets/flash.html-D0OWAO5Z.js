...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="write-flash-命令参数" tabindex="-1"><a class="header-anchor" href="#write-flash-命令参数" aria-hidden="true">#</a> write_flash 命令参数</h2><p><code>write_flash</code>命令有如下参数：</p><ol><li><code>--erase-all</code>或者<code>-e</code>，作用是在烧录的时候擦除全部flash，建议添加。</li><li><code>--no-progress</code>或者<code>-p</code>，作用是在下载的时候禁止显示进度条。</li></ol><div class="hint-container tip"><p class="hint-container-title">提示</p><p>若MCU中已刷入过其他固件，烧录新固件时请务必加上<code>-e</code>擦除参数。</p></div><div class="hint-container tip"><p class="hint-container-title">提示</p><p>如若使用不带外置晶振的USB转串口芯片导致通信失败，可能需要降低波特率再试，比如<code>9600</code>。</p></div>`,8)])])}const o=e(l,[["render",c],["__file","flash.html.vue"]]);export{o as default};
