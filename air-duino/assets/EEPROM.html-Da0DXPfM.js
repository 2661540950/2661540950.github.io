import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,e,o as t}from"./app-B8tYiuI_.js";const p={};function c(i,n){return t(),a("div",null,[...n[0]||(n[0]=[e(`<h2 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h2><p>EEPROM 是一种存储器，其值在电路板断电时保留。在 AirMCU 中，没有内置的 EEPROM，但是可以使用 Flash 模拟 EEPROM。一般来说，我们采用内置 flash 的最后一个 page 扇区（或者是其它可擦写的最小单位）来模拟。</p><h2 id="api" tabindex="-1"><a class="header-anchor" href="#api" aria-hidden="true">#</a> API</h2><p>要使用此库，请在代码顶部包含头文件：</p><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;EEPROM.h&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li>返回值：EEPROM 中的单元数。类型为<code>unsigned int</code>。</li></ul>`,47)])])}const u=s(p,[["render",c],["__file","EEPROM.html.vue"]]);export{u as default};
